...
function renderFocusPanel(r, idx) {
  ...
  focusCol.innerHTML =
    ...
    + '<label style="display:flex;align-items:center;gap:5px;cursor:pointer;font-size:11px;color:var(--mut2);white-space:nowrap"><input type="checkbox" id="fp-bet-entrou" style="cursor:pointer;margin:0" '+(r.betEntrou?'checked':'')+' onchange="updateFocusField(\'bet_entrou\',this.checked?1:0)"> Apostei</label>'
  ...
  filtered.forEach(function(r){
    ...
    var shComPerfil=sk?'<span style="color:var(--mut)">Descartada</span>':
      '<div style="display:flex;align-items:flex-start;justify-content:center;gap:10px">'
        ...
        +'</div>'
      +'</div>';
    var oddValHtml=sk?'-':'<div style="display:flex;flex-direction:column;gap:6px;align-items:center"><div style="display:flex;flex-direction:column;gap:2px;align-items:center"><span style="font-size:9px;color:var(--mut);text-transform:uppercase;letter-spacing:.4px">Odd</span><input type="text" placeholder="-" value="'+(r.odd||'')+'" data-i="'+i+'" data-f="odd" style="width:52px;text-align:center"></div><div style="display:flex;align-items:center;justify-content:space-between;width:100%"><label style="display:flex;align-items:center;gap:4px;font-size:9px;color:var(--mut);cursor:pointer;white-space:nowrap"><input type="checkbox" data-i="'+i+'" data-f="bet_entrou" style="cursor:pointer" '+(r.betEntrou?'checked':'')+'> Apostei</label></div><div style="display:flex;align-items:center;justify-content:space-between;width:100%"><label style="display:flex;align-items:center;gap:4px;font-size:9px;color:var(--mut);cursor:pointer;white-space:nowrap"><input type="checkbox" data-i="'+i+'" data-f="avb_nao_aberto" style="cursor:pointer" '+(r.avbNaoAberto?'checked':'')+'> Não aberto</label><a onclick="openAllDogsModal(\''+r.hora+'|'+r.corrida+'\')" title="Ver corrida completa (6 galgos)" style="cursor:pointer;font-size:13px;line-height:1;margin-left:auto">&#128196;</a></div></div>';
