...
function renderFocusPanel(r, idx) {
  ...
  focusCol.innerHTML =
    ...
    + '<input type="number" step="0.5" min="0" id="fp-bet-unidades" value="'+(r.betUnidades!=null?r.betUnidades:2.5)+'" title="Unidades (1 unidade = 1% da banca)" oninput="updateFocusField(\'bet_unidades\',this.value)" style="width:52px;text-align:center">'
