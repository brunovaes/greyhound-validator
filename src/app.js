...
document.addEventListener('DOMContentLoaded',function(){
  injectValModal();
  var vs=document.createElement('style');vs.textContent='#val-modal{position:fixed;inset:0;background:rgba(0,0,0,.75);display:none;align-items:center;justify-content:center;z-index:9000}#val-modal.open{display:flex}#val-box{background:#161b27;border:1px solid rgba(255,255,255,.12);border-radius:12px;width:82vw;max-width:820px;overflow:hidden;display:flex;flex-direction:column}#val-hdr{display:flex;align-items:center;justify-content:space-between;padding:9px 14px;border-bottom:1px solid rgba(255,255,255,.08)}#val-hdr h3{font-size:12px;font-weight:700;color:#fff;margin:0;flex:1;text-align:center}#val-xbtn{background:transparent;border:none;color:#888;font-size:16px;cursor:pointer;padding:0 4px;flex-shrink:0}#val-body{padding:10px 14px;display:flex;flex-direction:column;gap:0}.val-dog{width:100%}.val-dog-hdr{display:flex;align-items:center;gap:6px;margin-bottom:5px;padding-bottom:5px;border-bottom:1px solid rgba(255,255,255,.07)}.val-name{font-size:11px;font-weight:700;color:#fff}.val-perfil{font-size:9px;color:#888;margin-left:4px}.val-sep{height:1px;background:rgba(255,255,255,.07);margin:8px 0}.val-tbl{width:100%;border-collapse:collapse;font-size:10px}.val-tbl th{font-size:7.5px;color:rgba(255,255,255,.3);text-transform:uppercase;letter-spacing:.3px;padding:2px 4px;border-bottom:1px solid rgba(255,255,255,.07);white-space:nowrap;text-align:left}.val-tbl td{padding:3px 4px;border-bottom:1px solid rgba(255,255,255,.04);color:rgba(255,255,255,.8);white-space:nowrap}.val-tbl tr:last-child td{border-bottom:none}.val-tbl tr:hover td{background:rgba(255,255,255,.03)}.vcls{background:rgba(255,255,255,.07);padding:1px 5px;border-radius:3px;font-size:9px;color:#aaa}.val-link{font-size:9px;color:rgba(96,165,250,.75);cursor:pointer;display:block;text-align:center;margin-top:3px}';document.head.appendChild(vs);
