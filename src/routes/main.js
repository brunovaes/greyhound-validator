...
function renderTable(){
  ...
  avbs.forEach(function(r,i){
    ...
    var obsHtml=sk?'<span class="obs-c" style="font-size:10px;color:var(--mut)">'+obsRanking+'</span>':'<span class="obs-c" style="font-size:10px;color:var(--mut)">'+obsRanking+'</span>'+(obsNarrativa?'<div style="font-size:11px;color:var(--txt);margin-top:5px;padding-top:5px;border-top:1px solid rgba(255,255,255,.06);line-height:1.5;font-style:italic">'+obsNarrativa+'</div>':'');
