  ...
  <div class="sidebar">
    <div style="margin-bottom:-3px">
      ...
      <div class="tabnav">
        ...
        ${can(user,'analisar.carga_vip') ? `<button type="button" class="tabbtn" id="btn-carga-vip" onclick="abrirCargaVip()" style="width:100%;text-align:left;cursor:pointer;font-family:inherit;font-size:inherit;font-weight:inherit;line-height:inherit;letter-spacing:inherit;background:none;border:none;color:inherit;padding:inherit;margin:0">&#11088; Carga VIP</button>` : ''}
