...
function _analisaCorrida(histFull, histAll, raceCard, ctxBase, opts) {
  ...
  // SO TOP (Bruno set/2026: "menos e' mais"): o motor trabalha com UMA regua so. O principal e'
  // sempre TOP; a REGULAR de corrida foi descontinuada. (O rotulo 'REGULAR' abaixo e' so o papel
  // do slot secundario — 2a/3a linha da MESMA corrida —, nunca vira tier de corrida.)
